...
.adf-dateitem-editable {
  cursor: pointer; }
  .adf-dateitem-editable md-icon {
    width: 16px;
    height: 16px;
    opacity: 0.5;
    margin-left: 4px; }
  .adf-dateitem-editable:hover md-icon {
    opacity: 1; }
...
adf-start-task .adf-start-task-input-container .mat-input-wrapper {
  padding-top: 8px; }
...
adf-start-task .adf-invalid .mat-input-underline {
  background-color: #f44336 !important; }

adf-start-task .adf-invalid .adf-file {
  border-color: #f44336; }

adf-start-task .adf-invalid .mat-input-prefix {
  color: #f44336; }
...
.adf-people-search {
  ...
  .adf-people-search .search-text-header {
    font-weight: bold;
    opacity: 0.54; }
  .adf-people-search .search-text-container {
    width: 100%; }
    .adf-people-search .search-text-container input {
      line-height: normal; }
  .adf-people-search .search-list-container {
    max-height: 152px;
    width: 100%;
    overflow-y: auto; }
  .adf-people-search adf-people-list /deep/ adf-datatable /deep/ thead {
    display: none; }
...
.adf-search-container {
  display: flex;
  align-items: center; }
  .adf-search-container .adf-search-field {
    max-width: 260px;
    padding-top: 6px; }
    .adf-search-container .adf-search-field .mat-input-container {
      width: 100%; }
    .adf-search-container .adf-search-field .mat-input-underline .mat-input-ripple {
      background-color: white; }
    .adf-search-container .adf-search-field .mat-form-field-underline {
      background-color: white; }
    .adf-search-container .adf-search-field .mat-input-element {
      font-size: 16px;
      line-height: normal;
      padding-bottom: 2px; }
  .adf-search-container .adf-search-field .mat-input-infix {
    padding: 0; }

.adf-search-form {
  overflow: hidden; }

.adf--search-result-container {
  z-index: 5; }
