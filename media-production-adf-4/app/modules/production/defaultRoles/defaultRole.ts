...
export class DefaultRole {
  ...
  constructor(
    ...
    public nvpList_typeBudgetMin?: number,
    public nvpList_typeBudgetMax?: number,
    public nvpList_typeHolidayPaidRate?: number,
    public nvpList_typeOvertimePaidRate?: number,
    public nvpList_typeNoticePeriod?: number,
